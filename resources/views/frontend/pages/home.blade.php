...
<div role="main" class="main">
    <section class="section section-with-shape-divider section-parallax bg-tertiary border-0 m-0" data-plugin-parallax data-plugin-options="{'speed': 1.5, 'parallaxHeight': '110%', 'fadeIn': true}" data-image-src="{{ asset('assets/frontend/img/pic11.jpg') }}">
    ...
    <div class="container position-relative z-index-1" style="margin-top: -250px;">
            ...
            <div class="col-lg-6 pe-lg-4 mb-5 mb-lg-0">
                <div class="card border-0 custom-border-radius-1 box-shadow-1 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="900">
                    <div class="card-body p-5">
                        <h2 class="text-color-secondary font-weight-bold text-7 line-height-1 mb-1" style="padding-bottom: 20px">A message From Our President
                        </h2>
                        <p class="hwrite pb-1 mb-2" style="line-height: 25px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce elementum, nulla vel pellentesque consequat, ante nulla hendrerit arcu, ac tincidunt mauris lacus sed leo.</p>
                        <p class="hwrite pb-1 mb-2" style="line-height: 25px;">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce elementum, nulla vel pellentesque consequat, ante nulla hendrerit arcu, ac tincidunt mauris lacus sed leo.</p>
                        <p class="hwrite pb-1 mb-2" style="line-height: 25px;">Lorem ipsum dolor sit amet,Lorem ipsum</p>
                        <p class="hwrite pb-1 mb-2" style="line-height: 25px;">Lorem ipsum dolor sit amet,Lorem ipsum</p>
                        <p class="hwrite pb-1 mb-2" style="line-height: 25px;">Lorem ipsum dolor sit amet,Lorem ipsum</p>
                        
                        <p class="hwrite1 text-6 pb-1 mb-2" style="line-height: 25px;">Signature</p>
                        <div style="padding-left: 320px;margin-top: -165px">
                        <img alt="Porto" width="170" height="170" src="{{ asset('assets/frontend/img/desktop-device-1.png') }}" style="border-radius: 90px;">
                            </div>
                ...
                <div class="col-sm-10 col-lg-6 offset-sm-1 ps-sm-5 ps-lg-0">
                    <div class="position-relative">
                        <!-- <div data-plugin-float-element data-plugin-options="{'startPos': 'top', 'speed': 0.2, 'transition': true, 'transitionDuration': 1000, 'isInsideSVG': true}">
                            <img src="img/home/Home-services2.jpg" class="img-fluid rounded-circle custom-box-shadow-1 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1800" alt="" />
                        </div> -->
            ...
            <div class="row align-items-end pb-3 mb-5 mb-lg-4">
                ...
                <div class="col-lg-5 col-xl-4">
                    <div class="d-flex justify-content-lg-end">
                        <a href="demo-cleaning-services-services.html" class="btn btn-primary btn-modern font-weight-bold text-3 btn-px-4 py-3 appear-animation" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1800">VOIR TOUS LES SERVICES</a>
        ...
        <div class="container py-5 my-5">
            <div class="row align-items-center justify-content-center pt-3">
                ...
                <div class="col-xl-3 text-center text-xl-end">
                    <div class="position-relative">
                        <a href="demo-cleaning-services-contact.html" class="btn btn-secondary btn-modern font-weight-bold text-3 btn-px-4 py-3 appear-animation" data-appear-animation="fadeInRightShorter" data-appear-animation-delay="550">RÉSERVEZ MAINTENANT EN 60 SECONDES</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section section-with-shape-divider border-0 m-0" style="background-image: linear-gradient(to right, #00adee, #29b4bb, #87c445);">
        <div class="shape-divider" style="height: 116px;">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1920 116" preserveAspectRatio="xMinYMin">
                <path class="custom-svg-fill-color-tertiary-darken" d="M0,24c2.86,0.42,7.41,1.1,13,2c6.13,0.98,10.67,1.77,12,2c11.67,2.01,42.24,7.05,68,11
                    c7.79,1.2,22.72,3.48,41,6c20.75,2.86,38.83,5.06,74,9c41.19,4.61,62.09,6.95,93,10c57.4,5.66,101.17,9.03,114,10
                        ...
                        <div>
                            <div class="card custom-card-style-1">
                                <div class="card-body text-center py-5 px-4">
                                    ...
                                    <a href="demo-cleaning-services-contact.html" class="btn btn-secondary btn-modern font-weight-bold text-3 px-5 btn-py-3">RÉSERVEZ MAINTENANT</a>
                                </div>
                            </div>
                        </div>
                        <div>
    ...
    <section class="section section-with-shape-divider overlay overlay-show overlay-color-tertiary border-0 m-0" style="background-image: url({{ asset('assets/frontend/img/home/Home-bg2.jpg') }}); background-size: cover; background-position: center;">
        <div class="shape-divider shape-divider-reverse-x" style="height: 102px;">
            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1920 102" preserveAspectRatio="xMinYMin">
                <path fill="#F7F7F7" d="M1895,78c-56.71-6.03-113.75-12.1-167-17c-75.42-6.94-133.81-10.66-171-13c-62.1-3.91-108.85-5.97-155-8
                    c-35.96-1.58-78.06-3.42-133-5c-59.81-1.72-103.18-2.23-172-3c-92.17-1.03-154.41-1.01-169-1c-69.05,0.05-115.16,0.67-137,1
        ...
        <div class="container py-5 mt-5 mb-3">
            <div class="row justify-content-center py-5 my-4">
                <div class="col-lg-9 col-xl-7 text-center px-lg-4">
                    ...
                    <a href="demo-cleaning-services-prices.html" class="btn btn-secondary btn-modern font-weight-bold text-3 px-5 btn-py-3 appear-animation" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="600">VOIR LES PRIX</a>
                </div>
            </div>
        </div>
    </section>
